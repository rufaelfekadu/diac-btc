...
#     --input_paths \
#         data/clartts/raw/train/metadata.json \
#         data/arvoice/raw/train/metadata.json \
#         data/tuneSwitch/raw/train/metadata.json \
#         data/mixat/raw/train/metadata.json \
#     --split combined \
...
# python scripts/nemo/prep_manifest.py \
#     --input_paths \
#         data/clartts/raw/test/metadata.json \
#         data/arvoice/raw/test/metadata.json \
#         data/tuneSwitch/raw/validation/metadata.json \
#     --split test \
#     --output_path outputs/nemo
